jrobens@interlated.com.au 20160316 Took beautytips module and used jquery-webui  instead
due to jquery compatibility problems
  ...
  Place the downloaded directory 'excanvas_r3' inside the 'webuipopover
/other_libs' directory.
  ...
  The webuipopover
 module provides ballon-help style tooltip for any page element.
  It integrates webuipopover
 jQuery plugin by Jeff Robbins with Drupal.  Currently, this
  ...
  to add their own webuipopover
 popups to their site without having to delve into jQuery.
  
  For information about the Beauty Tips jQuery plugin:
    http://www.lullabot.com/articles/announcing-webuipopover
-jquery-tooltip-plugin
    http://www.lullabot.com/articles/webuipopover
-09-release
 ...
 js to every page
  ...
  If you enable the option 'Add webuipopover
 js to every page', then, anything with the
  class 'webuipopover
' will automatically have a popup which displays the 'title' attribute
  ...
  --------------------------------------------------------------------------------------
    webuipopover
 has an API so that you can create your own webuipopover
 and add them into
  any place on your site.  To do this, you will need to set up an array of options and 
  then pass them along to the webuipopover
_add_webuipopover
 function.  All of the options are
  ...
  information, and can accept a plethora of other optional info.
    ...
    1.  Each beautytip will need a name - distinct from other webuipopover
 added on the
        web page.
    ...
    3.  Each beautytip will need some text to display.  You can define what to display 
      ...
      a.  Use 'text' to directly add supply the text.  It can accept html.
        ex 1.  'text' => t('Here's some webuipopover
 text to display on this page.'),
  
      b.  Use 'contentSelector' to use jQuery to tell webuipopover
 where to find the text
          on a page.
        ex 2.  'contentSelector' => '$(this).next(".description").html()',
        This tells webuipopover
 to find the next item after the css selector with class
      ...
      d.  If none of the above 3 options are given, the webuipopover
 plugin will by default set
  ...
  ------------------------------------------------------------------------------------
    ex. Full options array and function call to add webuipopover
...
($options);
  ...
  hook_define_webuipopover
_styles() - allows a module to define its own base webuipopover

  styles.  (See webuipopover
_api.module for an example). This allows easier use of
  webuipopover
_add_webuipopover
 by allowing a style to be indicated instead of having to
  define all of the same options everytime.
  example of adding webuipopover
...
($options);
  ...
  This example will add webuipopover
 to the help page using the 'hulu' style
  as defined in the implementation of this hook in webuipopover
_api.module.
  
  Any defined style will also show up on the webuipopover
 settings page and
...
******************************************************************************
webuipopover
 options and defaults (Copied and pasted from the jQuery.bt.js file)
******************************************************************************
/**
...
jQuery.bt.defaults = {
  ...
  **Note: If you need to use 'preBuild', 'preShow', 'showTip', 'postShow', 'preHide', 'hideTip', or 'postHide', 
  then it's recommended that you add your webuipopover
 in javascript instead of in using this module's api.
